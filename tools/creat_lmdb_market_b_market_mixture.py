...
lmdb_file = '/home/jiening/SRCNN_JSTL/external/mixture_db/market_b_market_mixture/val_lmdb'
#lmdb_file = '/home/jiening/SRCNN_JSTL/external/mixture_db/market_b_market_mixture/train_lmdb'
...
txt_file = '/home/jiening/dgd_person_reid/external/exp_by/db/market/val.txt'
#txt_file = '/home/jiening/dgd_person_reid/external/exp_by/db/market/train.txt'
data_b_path_x2 = '/home/jiening/dgd_person_reid/external/exp_by/datasets/market_b_x2'
data_b_path_x3 = '/home/jiening/dgd_person_reid/external/exp_by/datasets/market_b_x3'
data_b_path_x4 = '/home/jiening/dgd_person_reid/external/exp_by/datasets/market_b_x4'
data_path = '/home/jiening/dgd_person_reid/external/exp_by/datasets/market'
...
for line in open(txt_file):  
    ...
    count+=1
    img_b = cv2.imread(join(data_b_path_x2,file_name))
    # print(img_b.shape)
    ...
    count+=1
    img_b = cv2.imread(join(data_b_path_x3,file_name))
    # print(img_b.shape)
    img_b = cv2.resize(img_b, (resize_width, resize_height)) 
    # print(img_b.shape)
    # img = cv2.imread(join(data_path,file_name))
    ...
    count+=1
    img_b = cv2.imread(join(data_b_path_x4,file_name))
    # print(img_b.shape)
    img_b = cv2.resize(img_b, (resize_width, resize_height)) 
    # print(img_b.shape)
    # img = cv2.imread(join(data_path,file_name))
