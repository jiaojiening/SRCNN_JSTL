...
#lmdb_file = '/home/jiening/SRCNN_JSTL/external/db/caviar_dataset_128x48_mixture/val_cam1_lmdb'
lmdb_file = '/home/jiening/SRCNN_JSTL/external/db/caviar_dataset_128x48_mixture/train_cam1_lmdb'
...
for line in open(txt_file):  
    ...
    # write batch
    if (count % batch_size == 0) or (count_file == file_length) :                          #每当累计到一定的数据量，便用commit方法写入硬盘
        lmdb_txn.commit()
