...
output_dir = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_ln_random'
cuhk01_dir_x2 = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b_x2'
cuhk01_dir_x3 = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b_x3'
cuhk01_dir_x4 = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b'
...
for i in pids_x2:
    # id = i//2
    index = 0
    file_name = 'cam_0/{:05d}_{:05d}.bmp'.format(i, index)
