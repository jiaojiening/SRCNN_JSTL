...
#basic setting
dataset_dir = '/home/jiening/SRCNN_JSTL/external/db/jstl_viper_ln_x3_market'
...
for line in open(txt_file):  
    ...
    if dataset == 'market':
        count+=1
        img_b = cv2.imread(join(market_data_b_path_x3, cam, file_name))
        ...
        if cam == 'cam_1':
            count+=1
            img_b = cv2.imread(join(data_b_path_x3, cam, file_name))
            img_b = cv2.resize(img_b, (resize_width, resize_height)) 
