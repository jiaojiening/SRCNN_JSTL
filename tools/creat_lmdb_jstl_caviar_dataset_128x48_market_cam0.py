...
#basic setting
lmdb_file = '/home/jiening/SRCNN_JSTL/external/db/jstl_caviar_dataset_128x48_market/val_cam0_lmdb'
#lmdb_file = '/home/jiening/SRCNN_JSTL/external/db/jstl_caviar_dataset_128x48_market/train_cam0_lmdb'
...
txt_file = '/home/jiening/dgd_person_reid/external/exp/db/jstl_caviar_dataset_128x48_market/val.txt'
#txt_file = '/home/jiening/dgd_person_reid/external/exp/db/jstl_caviar_dataset_128x48_market/train.txt'
...
for line in open(txt_file):  
    ...
    if dataset == 'caviar_dataset_128x48':
        if cam == 'cam_0':
            count+=1
