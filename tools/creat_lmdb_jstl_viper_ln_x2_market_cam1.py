...
#basic setting
dataset_dir = '/home/jiening/SRCNN_JSTL/external/db/jstl_viper_ln_x2_market'
...
#txt_file = '/home/share/jiening/dgd_datasets/exp/db/jstl_viper_market/val.txt'
txt_file = '/home/share/jiening/dgd_datasets/exp/db/jstl_viper_market/train.txt'
...
# data_b_path_x4 = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b_x4'
data_path = '/home/jiening/dgd_person_reid/external/exp/datasets/viper'
...
for line in open(txt_file):  
    ...
    if dataset == 'market':
        count+=1
        img_b = cv2.imread(join(market_data_b_path_x2, cam, file_name))
        ...
        if cam == 'cam_1':
            count+=1
            img_b = cv2.imread(join(data_b_path_x2, cam, file_name))
            img_b = cv2.resize(img_b, (resize_width, resize_height)) 
