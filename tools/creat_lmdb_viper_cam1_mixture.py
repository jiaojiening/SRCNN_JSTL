...
lmdb_file = '/home/jiening/SRCNN_JSTL/external/db/viper_ln_mixture/val_cam1_lmdb'
# lmdb_file = '/home/jiening/SRCNN_JSTL/external/db/viper_ln_mixture/train_cam1_lmdb'
...
txt_file = '/home/jiening/dgd_person_reid/external/exp/db/viper_ln/val.txt'
# txt_file = '/home/jiening/dgd_person_reid/external/exp/db/viper_ln/train.txt'
data_b_path = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b'
data_b_path_x2 = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b_x2'
data_b_path_x3 = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_b_x3'
data_path = '/home/jiening/dgd_person_reid/external/exp/datasets/viper_ln'
...
for line in open(txt_file):  
    ...
    if file_name[0:5] == 'cam_1':
      ...
      count_cam1+=1
      img_b = cv2.imread(join(data_b_path,file_name))
      # print(img_b.shape)
      img_b = cv2.resize(img_b, (resize_width, resize_height)) 
      # print(img_b.shape)
      img = cv2.imread(join(data_path,file_name))
