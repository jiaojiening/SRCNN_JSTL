...
train_model ${exp} cuhk01_ln_mixture_feature_loss_new_market_mixture_x2 ${pretrained_model}
...
train_model ${exp} cuhk01_ln_mixture_feature_loss_new_market_mixture_x3 ${pretrained_model}
...
train_model ${exp} cuhk01_ln_mixture_feature_loss_new_market_mixture_x4 ${pretrained_model}
