...
train_model ${exp} caviar_dataset_128x48_l_hl_x2_feature_loss_new_market_x4_x2 ${pretrained_model1}
train_model ${exp} caviar_dataset_128x48_l_hl_x2_feature_loss_new_market_x4_x3 ${pretrained_model2}
train_model ${exp} caviar_dataset_128x48_l_hl_x2_feature_loss_new_market_x4_x4 ${pretrained_model3}
