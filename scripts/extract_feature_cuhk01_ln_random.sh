...
trained_model=$(get_trained_model ${exp} cuhk01_ln_random_x2_feature_loss_0_new_sr_loss_0)
...
#trained_model='/home/jiening/SRCNN_JSTL/caffemodels/sr_models/cuhk01_sr_x2.caffemodel'
#trained_model=$(get_trained_model ${exp} cuhk01_ln_random_x3_feature_loss_0_new)
trained_model=$(get_trained_model ${exp} cuhk01_ln_random_x3_feature_loss_0_new_sr_loss_0)
...
#trained_model='/home/jiening/SRCNN_JSTL/caffemodels/sr_models/cuhk01_sr_x3.caffemodel'
#trained_model=$(get_trained_model ${exp} cuhk01_ln_random_x4_feature_loss_0_new)
trained_model=$(get_trained_model ${exp} cuhk01_ln_random_x4_feature_loss_0_new_sr_loss_0)
