...
#train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_0 ${pretrained_model}
#train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_0.2 ${pretrained_model}
#train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_0.4 ${pretrained_model}
#train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_0.8 ${pretrained_model}
train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_1.2 ${pretrained_model}
train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_1.4 ${pretrained_model}
train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_1.6 ${pretrained_model}
train_model ${exp} viper_ln_random_x2_feature_loss_0_new_sr_loss_1.8 ${pretrained_model}
...
#train_model ${exp} viper_ln_random_x3_feature_loss_0_new_sr_loss_0.4 ${pretrained_model}
train_model ${exp} viper_ln_random_x3_feature_loss_0_new_sr_loss_0.8 ${pretrained_model}
train_model ${exp} viper_ln_random_x3_feature_loss_0_new_sr_loss_1.2 ${pretrained_model}
train_model ${exp} viper_ln_random_x3_feature_loss_0_new_sr_loss_1.4 ${pretrained_model}
train_model ${exp} viper_ln_random_x3_feature_loss_0_new_sr_loss_1.6 ${pretrained_model}
train_model ${exp} viper_ln_random_x3_feature_loss_0_new_sr_loss_1.8 ${pretrained_model}
...
#train_model ${exp} viper_ln_random_x4_feature_loss_0_new_sr_loss_0.4 ${pretrained_model}
train_model ${exp} viper_ln_random_x4_feature_loss_0_new_sr_loss_0.8 ${pretrained_model}
train_model ${exp} viper_ln_random_x4_feature_loss_0_new_sr_loss_1.2 ${pretrained_model}
train_model ${exp} viper_ln_random_x4_feature_loss_0_new_sr_loss_1.4 ${pretrained_model}
train_model ${exp} viper_ln_random_x4_feature_loss_0_new_sr_loss_1.6 ${pretrained_model}
train_model ${exp} viper_ln_random_x4_feature_loss_0_new_sr_loss_1.8 ${pretrained_model}
