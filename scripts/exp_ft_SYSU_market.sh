...
#train_model ${exp} SYSU_3_ln_x2_feature_loss_new ${pretrained_model}
#pretrained_model='caffemodels/SRCNN_market_x3.caffemodel'
#train_model ${exp} SYSU_3_ln_x3_feature_loss_new ${pretrained_model}
pretrained_model='caffemodels/SRCNN_market.caffemodel'
train_model ${exp} SYSU_3_ln_x4_feature_loss_new ${pretrained_model}
