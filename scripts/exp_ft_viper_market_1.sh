...
pretrained_model1='external/snapshots/market/market_b_market_x3_feature_loss_new_iter_5000.caffemodel'
pretrained_model2='external/snapshots/market/market_b_market_x2_feature_loss_new_iter_5000.caffemodel'
#pretrained_model3='external/snapshots/market/market_b_market_x3_feature_loss_new_iter_5000.caffemodel'
...
train_model ${exp} viper_ln_feature_loss_new_market_x4_x3 ${pretrained_model1}
train_model ${exp} viper_ln_feature_loss_new_market_x4_x2 ${pretrained_model2}
