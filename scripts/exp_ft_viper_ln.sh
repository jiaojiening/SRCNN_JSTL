...
#train_model ${exp} viper_ln_feature_loss_0_sr_loss_1.4_lr_10_new ${pretrained_model}
#train_model ${exp} viper_ln_feature_loss_0_sr_loss_1.6_lr_10_new ${pretrained_model}
#train_model ${exp} viper_ln_feature_loss_0_sr_loss_1.8_lr_10_new ${pretrained_model}
train_model ${exp} viper_ln_feature_loss_0_sr_loss_2.0_lr_10_new ${pretrained_model}
