...
train_model ${exp} caviar_dataset_128x48_mixture_feature_loss_new_market_mixture_x2 ${pretrained_model}
...
train_model ${exp} caviar_dataset_128x48_mixture_feature_loss_new_market_mixture_x3 ${pretrained_model}
...
train_model ${exp} caviar_dataset_128x48_mixture_feature_loss_new_market_mixture_x4 ${pretrained_model}
