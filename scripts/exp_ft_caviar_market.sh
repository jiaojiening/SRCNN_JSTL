...
train_model ${exp} caviar_dataset_128x48_feature_loss_new_market_x4_x4 ${pretrained_model1}
train_model ${exp} caviar_dataset_128x48_feature_loss_new_market_x3_x3 ${pretrained_model2}
train_model ${exp} caviar_dataset_128x48_feature_loss_new_market_x2_x2 ${pretrained_model3}
train_model ${exp} caviar_dataset_128x48_feature_loss_new_market_x4_x3 ${pretrained_model4}
train_model ${exp} caviar_dataset_128x48_feature_loss_new_market_x4_x2 ${pretrained_model5}

#train_model ${exp} viper_ln_feature_loss_new_market_x4_x4 ${pretrained_model1}
#train_model ${exp} viper_ln_feature_loss_new_market_x3_x3 ${pretrained_model2}
#train_model ${exp} viper_ln_feature_loss_new_market_x2_x2 ${pretrained_model3}
#train_model ${exp} viper_ln_feature_loss_new_market_x4_x3 ${pretrained_model4}
#train_model ${exp} viper_ln_feature_loss_new_market_x4_x2 ${pretrained_model5}
#train_model ${exp} caviar_dataset_128x48_feature_loss_new_market_x4_x2 ${pretrained_model5}
