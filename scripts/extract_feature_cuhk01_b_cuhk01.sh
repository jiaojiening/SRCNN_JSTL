...
for dataset in cuhk01_b_cuhk01;do
  ...
  #trained_model=$(get_trained_model ${exp} cuhk01_ln_feature_loss_new_sr_lr_0)
  #trained_model=$(get_trained_model ${exp} cuhk01_ln_feature_loss_0_new)
  #trained_model=$(get_trained_model ${exp} cuhk01_ln_SR_loss_0_new)
  #trained_model=$(get_trained_model ${exp} cuhk01_ln_feature_loss_new_v1)
  trained_model=$(get_trained_model ${exp} cuhk01_ln_feature_loss_0_sr_loss_0_lr_10_new)
  echo $trained_model
