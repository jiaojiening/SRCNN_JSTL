...
train_model ${exp} cuhk01_ln_random_x4_feature_loss_0_id_sr_0_new ${pretrained_model}
...
pretrained_model='caffemodels/SRCNN_market.caffemodel'
#train_model ${exp} cuhk01_ln_random_x4_feature_loss_0_new ${pretrained_model}
train_model ${exp} caviar_dataset_128x48_l_hl_x4_random_x4_feature_loss_0_id_sr_0_new ${pretrained_model}

pretrained_model='caffemodels/SRCNN_market_x2.caffemodel'
#train_model ${exp} caviar_dataset_128x48_l_hl_x2_feature_loss_0_id_sr_0_new ${pretrained_model}

pretrained_model='caffemodels/SRCNN_market_x3.caffemodel'
train_model ${exp} caviar_dataset_128x48_l_hl_x3_feature_loss_0_id_sr_0_new ${pretrained_model}
