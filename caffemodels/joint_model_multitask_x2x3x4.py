...
net_file = '/home/jiening/SRCNN_JSTL/models/SRCNN_x2x3x4_multitask_JSTL_mat.prototxt'

# set all the caffemodels 
caffe_model1 = '/home/share/jiening/dgd_datasets/exp/snapshots/jstl/market_iter_10000.caffemodel'
caffe_model2 = '/home/jiening/SRCNN_JSTL/caffemodels/SR_9-5-5_conv_3_x2.caffemodel'
caffe_model3 = '/home/jiening/SRCNN_JSTL/caffemodels/SR_9-5-5_conv_3_x3.caffemodel'
caffe_model4 = '/home/jiening/SRCNN_JSTL/caffemodels/SR_9-5-5_conv_3_x4.caffemodel'
...
print(net2.params['SR_conv3_x2'][1].data)
print(net3.params['SR_conv3_x3'][1].data)
print(net4.params['SR_conv3_x4'][1].data)


# load the params to net1 from net2
params_x2 = ['SR_conv1_x2','SR_conv2_x2','SR_conv3_x2']
...
# net1.params['SR_conv3_x2'][0].data.flat = net2.params['SR_conv3'][0].data.flat
# net1.params['SR_conv3_x2'][1].data[...] = net2.params['SR_conv3'][1].data
# net1_params = {'SR_conv3_x2': (net1.params[pr][0].data, net1.params[pr][1].data)}
# net2_params = {'SR_conv3': (net2.params[pr][0].data, net2.params[pr][1].data)}
# net1_params['SR_conv3_x2'][0].flat = net2_params['SR_conv3'][0].flat #flat unrolls the array
# net1_params['SR_conv3_x2'][1][...] = net2_params['SR_conv3'][1]

# load the params to net1 from net3
params_x3 = ['SR_conv1_x3','SR_conv2_x3','SR_conv3_x3']
...
# net1.params['SR_conv3_x3'][0].data.flat = net3.params['SR_conv3'][0].data.flat
# net1.params['SR_conv3_x3'][1].data[...] = net3.params['SR_conv3'][1].data
  
# load the params to net1 from net4
params_x4 = ['SR_conv1_x4','SR_conv2_x4','SR_conv3_x4']
...
# net1.params['SR_conv3_x4'][0].data.flat = net2.params['SR_conv3'][0].data.flat
# net1.params['SR_conv3_x4'][1].data[...] = net2.params['SR_conv3'][1].data
...
e = net1.params['SR_conv1_x4'][1].data
print(e)
print(net1.params['SR_conv3_x2'][1].data)
print(net1.params['SR_conv3_x3'][1].data)
print(net1.params['SR_conv3_x4'][1].data)

# save caffemodels
net1.save('/home/jiening/SRCNN_JSTL/caffemodels/SRCNN_x2x3x4_multitask_market.caffemodel')
