...
#caffe_model1 = '/home/share/jiening/dgd_datasets/exp/snapshots/jstl/viper_srn_x2_iter_500.caffemodel'
#caffe_model1 = '/home/share/jiening/dgd_datasets/exp/snapshots/jstl/viper_srn_x2_iter_500.caffemodel'
caffe_model1 = '/home/share/jiening/dgd_datasets/exp/snapshots/jstl/viper_srn_iter_500.caffemodel'
...
print(g)
#net1.save('viper_sr_x2.caffemodel')
#net1.save('viper_sr_x3.caffemodel')
net1.save('viper_sr_x4.caffemodel')
