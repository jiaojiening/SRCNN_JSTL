...
#caffe_model1 = '/home/jiening/SRCNN_JSTL/caffemodels/jstl_iter_55000.caffemodel'
...
print(g)
#net1.save('SRCNN_market.caffemodel')
#net1.save('SRCNN_market_x3.caffemodel')
#net1.save('SRCNN_market_x2.caffemodel')
