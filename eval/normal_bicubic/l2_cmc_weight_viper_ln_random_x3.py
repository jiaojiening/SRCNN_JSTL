...
results_dir_n = '/home/jiening/SRCNN_JSTL/external/results/ft_jstl/random/viper_b_viper_random_viper_ln_random_x3_feature_loss_0_new_iter_1000_fc7_bn'
results_dir_b = '/home/share/jiening/dgd_datasets/exp/results/jstl/viper_ln_random_b_x3_viper_ln_random_b_x3_multitask_iter_500_fc7_bn'
output_dir = '/home/jiening/SRCNN_JSTL/external/results/normal_bicubic/viper_ln_random_x3_normal_bicubic_average_multitask'
...
# D1 = D1/(np.sum(D1))
# set the D1_weight
for D1_weight in np.arange(0,1,0.1):
    D = (D0+D1_weight*D1)/2
    C = cmc(D, GY, PY)
    np.save(osp.join(output_dir, 'cmc_' + 'weight_euclidean_' + str(D1_weight)), C)
    np.save(osp.join(output_dir, 'distance_' + 'weight_euclidean_' + str(D1_weight)), D)
