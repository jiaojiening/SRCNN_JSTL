...
output_file = 'caviar_dataset_128x48_l_h_caviar_dataset_128x48_l_hl_normalization_weight_feature_loss_new_0_iter_1000_fc7_bn'
...
# for theta in np.arange(0.1, 1.1, 0.1):
  ...
  for i in xrange(len(resolution)):
      ...
      # weight_sum = D0_weight+D1_weight+D2_weight
      # print(weight_sum)
